...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post musics_url, params: { music: { artist: @music.artist, lyric: @music.lyric, title: @music.title, url_image: @music.url_image } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { artist: @music.artist, lyric: @music.lyric, title: @music.title, url_image: @music.url_image } }
