...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { content: @info.content, title: @info.title, url_image: @info.url_image } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { content: @info.content, title: @info.title, url_image: @info.url_image } }
