...
class ScriptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create script" do
    assert_difference('Script.count') do
      post scripts_url, params: { script: { content: @script.content, title: @script.title, url_image: @script.url_image } }
    end
  ...
  test "should update script" do
    patch script_url(@script), params: { script: { content: @script.content, title: @script.title, url_image: @script.url_image } }
